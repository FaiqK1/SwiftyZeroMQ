...
class ZeroMQTests: XCTestCase {
    ...
    func testVersion() {
        let (major, minor, patch, versionString) = SwiftyZMQ.version
    ...
    func testContext() {
        do {
            ...
            // Hashable
            let c1 = try SwiftyZMQ.Context()
            let c2 = try SwiftyZMQ.Context()
    ...
    func testSocket() {
        do {
            ...
            let socketTypes : [SwiftyZMQ.SocketType] = [
